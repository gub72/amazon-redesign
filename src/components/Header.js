  ...
  return (
    <header className="header" role="banner">
      <div className="header__container">
        ...
        {/* Logo (Desktop & Mobile) */}
        <Link to="/" className="header__logoLink" aria-label="Amazon Página Inicial">
          <svg className="header__logo" width="82" height="25" viewBox="0 0 82 25" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {/* Desktop Search */}
        <form 
          className="header__search header__search--desktop mobile-hidden" 
          role="search"
          onSubmit={(e) => { e.preventDefault(); handleSearch(); }}
        >
          <label htmlFor="product-search" className="visually-hidden">Pesquisar produtos</label>
          <div className="header__searchFilterContainer" ref={dropdownRef}>
            ...
            {showCategoryDropdown && (
              <>
                ...
                <ul className="header__searchDropdown" role="listbox">
                  {categories.map((cat) => (
                    <li
                      key={cat}
                      role="option"
          ...
          />
          <button type="submit" className="header__searchIcon header__searchIcon--desktop" aria-label="Pesquisar">
            <AiOutlineSearch style={{ fontSize: "18px", color: "#fff" }} aria-hidden="true" />
          </button>
        </form>
        ...
        <nav className="header__nav">
          ...
          <div className="header__mobileIcons desktop-hidden">
            <button className="header__mobileIcon" onClick={() => setShowMobileSearch(!showMobileSearch)} aria-label={showMobileSearch ? "Fechar busca" : "Abrir busca"}>
              {showMobileSearch ? <CgClose aria-hidden="true" /> : <AiOutlineSearch aria-hidden="true" />}
            </button>
            <button className="header__mobileIcon" onClick={handleAuthentication} aria-label="Minha conta">
              <svg className="header__iconLoginSvg" width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_206_120)">
                  <path d="M19.0609 17.5332C17.5787 14.9719 15.2519 13.1748 12.5481 12.4126C13.8626 11.7444 14.9138 10.6529 15.5321 9.31421C16.1504 7.9755 16.2998 6.46757 15.9563 5.03355C15.6127 3.59953 14.7962 2.32301 13.6384 1.40982C12.4806 0.496635 11.049 0 9.57436 0C8.09976 0 6.66814 0.496635 5.51033 1.40982C4.35252 2.32301 3.53601 3.59953 3.19245 5.03355C2.8489 6.46757 2.99832 7.9755 3.61663 9.31421C4.23494 10.6529 5.2861 11.7444 6.60061 12.4126C3.89686 13.1738 1.56998 14.971 0.0877973 17.5332C0.0470983 17.5972 0.0197704 17.6688 0.00745781 17.7437C-0.00485481 17.8185 -0.00189761 17.8951 0.0161512 17.9688C0.0342 18.0425 0.0669675 18.1117 0.112483 18.1724C0.157998 18.2331 0.21532 18.284 0.281 18.3219C0.34668 18.3599 0.419362 18.3842 0.494672 18.3934C0.569982 18.4025 0.646365 18.3963 0.719224 18.3752C0.792084 18.354 0.859915 18.3184 0.918637 18.2704C0.977359 18.2223 1.02576 18.1629 1.06092 18.0957C2.86186 14.9841 6.04373 13.1269 9.57436 13.1269C13.105 13.1269 16.2869 14.9841 18.0878 18.0957C18.123 18.1629 18.1714 18.2223 18.2301 18.2704C18.2888 18.3184 18.3566 18.354 18.4295 18.3752C18.5024 18.3963 18.5787 18.4025 18.654 18.3934C18.7294 18.3842 18.802 18.3599 18.8677 18.3219C18.9334 18.284 18.9907 18.2331 19.0362 18.1724C19.0818 18.1117 19.1145 18.0425 19.1326 17.9688C19.1506 17.8951 19.1536 17.8185 19.1413 17.7437C19.129 17.6688 19.1016 17.5972 19.0609 17.5332ZM4.13686 6.56444C4.13686 5.489 4.45576 4.43772 5.05324 3.54352C5.65072 2.64933 6.49995 1.95239 7.49352 1.54084C8.48709 1.12929 9.58039 1.02161 10.6352 1.23142C11.6899 1.44122 12.6588 1.9591 13.4193 2.71954C14.1797 3.47999 14.9074 5.50363 14.9074 5.50363C14.9074 5.50363 15.0095 7.6517 14.598 8.64528C14.1864 9.63885 13.4895 10.4881 12.5953 11.0856C11.7011 11.683 10.6498 12.0019 9.57436 12.0019C8.13278 12.0002 6.75074 11.4268 5.73139 10.4074C4.71203 9.38806 4.1386 8.00602 4.13686 6.56444Z" fill="white" />
                </g>
          ...
          <Link to="/checkout" className="header__navLink header__navLink--cart" aria-label={`Carrinho com ${cart.length} itens`}>
      ...
      {showMobileSearch && (
        <div className="header__mobileSearch desktop-hidden">
          ...
          >
            ...
            />
            <button type="submit" className="header__searchIcon header__searchIcon--mobile" aria-label="Pesquisar">
              <AiOutlineSearch />
            </button>
          </form>
        </div>
      ...
      <aside 
        className={`desktop-hidden header__mobileNav ${mobileNav ? "header__mobileNav--active" : ""}`} 
        id="mobile-nav"
      ...
      >
        <div className={`header__mobileNavContainer ${mobileNav ? "header__mobileNavContainer--active" : ""}`}>
          <div className="header__mobileNavHeader">
            <div className="header__mobileNavUser">
              <MdPersonOutline className="header__mobileNavUserIcon" aria-hidden="true" />
              <span className="header__mobileNavUserEmail">Olá, {profile ? getUserName(profile) : "Faça seu login"}</span>
            </div>
          </div>
          <nav className="header__mobileNavContent">
            <div className="header__mobileNavSection">
              <h3>Tendências</h3>
              <ul>
                <li><Link to="/best-sellers" onClick={() => setMobileNav(false)}>Mais vendidos <AiOutlineRight aria-hidden="true" /></Link></li>
                <li><Link to="/new-releases" onClick={() => setMobileNav(false)}>Novidades <AiOutlineRight aria-hidden="true" /></Link></li>
                <li><Link to="/movers-shakers" onClick={() => setMobileNav(false)}>Produtos em alta <AiOutlineRight aria-hidden="true" /></Link></li>
              </ul>
            </div>
            <div className="header__mobileNavSeparator" aria-hidden="true" />
            <div className="header__mobileNavSection">
              <h3>Conteúdo Digital</h3>
              <ul>
                <li><Link to="/prime-video" onClick={() => setMobileNav(false)}>Prime Video <AiOutlineRight aria-hidden="true" /></Link></li>
                <li><Link to="/music" onClick={() => setMobileNav(false)}>Amazon Music <AiOutlineRight aria-hidden="true" /></Link></li>
                <li><Link to="/kindle" onClick={() => setMobileNav(false)}>Kindle <AiOutlineRight aria-hidden="true" /></Link></li>
              </ul>
            </div>
            <div className="header__mobileNavSeparator" aria-hidden="true" />
            <div className="header__mobileNavSection">
              ...
              <ul>
                ...
                <li><Link to="/account" onClick={() => setMobileNav(false)}>Sua Conta <AiOutlineRight aria-hidden="true" /></Link></li>
                <li><Link to="/help" onClick={() => setMobileNav(false)}>Ajuda <AiOutlineRight aria-hidden="true" /></Link></li>
                {profile ? (
                  <li><button className="header__mobileNavLogout" onClick={() => { auth.signOut(); setMobileNav(false); }}>Sair <AiOutlineRight aria-hidden="true" /></button></li>
                ) : (
                  <li><Link to="/login" onClick={() => setMobileNav(false)}>Login / Cadastrar <AiOutlineRight aria-hidden="true" /></Link></li>
                )}
              </ul>
            </div>
          </nav>
        ...
        <button 
          className={`header__toggleClose ${mobileNav ? "header__toggleClose--active" : ""}`} 
